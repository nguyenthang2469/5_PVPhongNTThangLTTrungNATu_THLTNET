...
namespace QuanLyThuVien.Taikhoan
{
    public partial class frmQuanlynhanvien : Form
    {
        ...
        {
            Tuple<int, System.Data.DataTable> result = Nhanvien.searchNhanvien(pageSize, pageIndex, keySearch);
            System.Data.DataTable employees = result.Item2;
        ...
        private void btnXuatexcel_Click(object sender, EventArgs e)
        {
            try
            {
                System.Data.DataTable dataTable = Nhanvien.exportToExcel(keySearch);
                ...
                for (int i = 0; i < dataTable.Columns.Count; i++)
                {
                    ...
                    // Thiết lập định dạng cho cột số điện thoại
                    if (dataTable.Columns[i].ColumnName == "Số điện thoại")
                    {
                        Range column = worksheet.Columns[i + 1];
                        column.NumberFormat = "0000000000"; // 10 chữ số, hiển thị số 0 ở đầu
                    }
                }
